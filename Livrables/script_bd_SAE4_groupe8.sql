...
CREATE TABLE IF NOT EXISTS `USER`
 (
   `ID_USER` BIGINT(4) NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS `BORROW`
 (
   `ID_BORROW` BIGINT(4) NOT NULL AUTO_INCREMENT ,
...
# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE `BORROW`
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_BORROW_USER
     ON `BORROW` (`ID_USER` ASC);

CREATE  INDEX I_FK_BORROW_BOOK
     ON `BORROW` (`ID_BOOK` ASC);
...
CREATE TABLE IF NOT EXISTS LANGUAGE
 (
   `ID_LANGUAGE` BIGINT(4) NOT NULL AUTO_INCREMENT ,
   `LIB_LANGUAGE` CHAR(255) NOT NULL  
...
CREATE TABLE IF NOT EXISTS `AUTHOR`
 (
   `ID_AUTHOR` BIGINT(4) NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS `CATEGORY`
 (
   `ID_CATEGORY` BIGINT(4) NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS `BOOK`
 (
   `ID_BOOK` BIGINT(4) NOT NULL AUTO_INCREMENT ,
   `ID_LANGUAGE` BIGINT(4) NULL  ,
   `TITLE`TEXT NOT NULL  ,
   `IMAGE` TEXT NULL  ,
   `DESCRIPTION` TEXT NULL  ,
   `NUMBER_OF_PAGES` BIGINT(4) NULL  ,
   `EDITOR` TEXT NULL  ,
...
# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE `BOOK`
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_BOOK_LANGUAGE
     ON `BOOK` (`ID_LANGUAGE` ASC);
...
CREATE  INDEX I_FK_WRITE_AUTHOR
     ON `WRITE` (`ID_AUTHOR` ASC);

CREATE  INDEX I_FK_WRITE_BOOK
     ON `WRITE` (`ID_BOOK` ASC);
...
# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE TAG
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_TAG_BOOK
     ON `TAG` (`ID_BOOK`ASC);

CREATE  INDEX I_FK_TAG_CATEGORY
     ON `TAG` (`ID_CATEGORY` ASC);
...
# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE RATING
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_RATING_USER
     ON `RATING` (`ID_USER` ASC);

CREATE  INDEX I_FK_RATING_BOOK
     ON `RATING` (`ID_BOOK` ASC);
...
CREATE TABLE IF NOT EXISTS `FOLLOW`
 (
   ...
   , PRIMARY KEY (`ID_USER_FOLLOW`,`ID_USER_IS_FOLLOWED`) 
 ) 
 comment = "";

# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE FOLLOW
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_FOLLOW_USER
     ON `FOLLOW`(`ID_USER_FOLLOW` ASC);

CREATE  INDEX I_FK_FOLLOW_USER1
     ON `FOLLOW` (`ID_USER_IS_FOLLOWED` ASC);
...
ALTER TABLE `BORROW` 
  ADD FOREIGN KEY `FK_BORROW_USER` (`ID_USER`)
      REFERENCES `USER` (`ID_USER`) ;

ALTER TABLE `BORROW`
  ADD CONSTRAINT `CHK_borrow_date_valid` CHECK (`START_DATE`< `END_DATE`); 

ALTER TABLE `BORROW`
  ADD FOREIGN KEY `FK_BORROW_BOOK` (`ID_BOOK`)
      REFERENCES `BOOK` (`ID_BOOK`) ;


ALTER TABLE `BOOK`
  ADD FOREIGN KEY `FK_BOOK_LANGUAGE` (`ID_LANGUAGE`)
      REFERENCES LANGUAGE (`ID_LANGUAGE`) ;


ALTER TABLE `WRITE`
  ADD FOREIGN KEY `FK_WRITE_AUTHOR` (`ID_AUTHOR`)
      REFERENCES `AUTHOR` (`ID_AUTHOR`) ;


ALTER TABLE `WRITE` 
  ADD FOREIGN KEY `FK_WRITE_BOOK` (`ID_BOOK`)
      REFERENCES `BOOK` (`ID_BOOK`) ;


ALTER TABLE `TAG` 
  ADD FOREIGN KEY `FK_TAG_BOOK` (`ID_BOOK`)
      REFERENCES `BOOK` (`ID_BOOK`) ;


ALTER TABLE `TAG`
  ADD FOREIGN KEY `FK_TAG_CATEGORY` (`ID_CATEGORY`)
      REFERENCES `CATEGORY` (`ID_CATEGORY`) ;


ALTER TABLE `RATING`
  ADD FOREIGN KEY `FK_RATING_USER` (`ID_USER`)
      REFERENCES `USER` (`ID_USER`) ;


ALTER TABLE `RATING`
  ADD FOREIGN KEY `FK_RATING_BOOK` (`ID_BOOK`)
      REFERENCES `BOOK` (`ID_BOOK`) ;

ALTER TABLE `RATING` 
ADD CONSTRAINT `CHK_valid_rate` CHECK(`RATE`<=5);

ALTER TABLE `FOLLOW`
  ADD FOREIGN KEY `FK_FOLLOW_USER` (`ID_USER_FOLLOW`)
      REFERENCES `USER` (`ID_USER`) ;


ALTER TABLE `FOLLOW`
  ADD FOREIGN KEY `FK_FOLLOW_USER1` (`ID_USER_IS_FOLLOWED`)
      REFERENCES `USER` (`ID_USER`) ;



--
-- déclencheur sur la table Rating qui vas vérifier l'existence d'un emprunt (borrow) avant d'ajouter une note
--

DELIMITER //
CREATE TRIGGER check_if_borrowed_before_rating
...
(94, 1, 'Œuvres complétes de Anatole France: La vie littéraire, 1-2 sér', 'http://books.google.com/books/content?id=v1EJDky1o7kC&printsec=frontcover&img=1&zoom=5&source=gbs_api', NULL, 688, NULL),
(95, 1, 'Coffret Anatole France', 'http://books.google.com/books/content?id=UBArEAAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', 'Ce coffret contient trois œuvres d Anatole France : Thaïs, Le Lys rouge et Les dieux ont soif. Retrouvez d autres auteurs dans la collection Coffrets Classiques : Alexandre Dumas, Homère, Victor Hugo, Marivaux, Molière, Émile Zola, Honoré de Balzac, Guy de Maupassant, George Sand...', 1120, 'BnF collection ebooks'),
...
(102, 1, 'Apollinaire', 'http://books.google.com/books/content?id=TsJ-vMU3i2YC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', 'APOLLINAIRE, Guillaume, poète français, 1880-1918', 164, 'RENAISSANCE DU LIVRE'),
...
(131, 1, 'Oeuvres complètes de Gustave Flaubert', 'http://books.google.com/books/content?id=Rgc-AQAAMAAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', NULL, 432, NULL),
(132, 1, 'Flaubert et l Afrique', 'http://books.google.com/books/content?id=JX09AQAAMAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api', NULL, 42, NULL),
(133, 1, 'A la recherche du temps perdu', 'http://books.google.com/books/content?id=VVj-oQEACAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api', 'Les parties blanches de barbes jusque-là entièrement noires rendaient mélancolique le paysage humain de cette matinée, comme les premières feuilles jaunes des arbres alors qu on croyait encore pouvoir compter sur un long été, et qu avant d avoir commencé d en profiter on voit que c est déjà l automne. Alors moi qui depuis mon enfance, vivant au jour le jour et ayant reçu d ailleurs de moi-même et des autres une impression définitive, je m aperçus pour la première fois, d après les métamorphoses qui s étaient produites dans tous ces gens, du temps qui avait passé pour eux, ce qui me bouleversa par la révélation qu il avait passé aussi pour moi. Et indifférente en elle-même, leur vieillesse me désolait en m avertissant des approches de la mienne.', 447, 'Editions Gallimard'),
(134, 2, 'The Complete Short Stories of Marcel Proust', 'http://books.google.com/books/content?id=fP1UvtGM8bwC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', 'This volume gathers together all of Marcel Proust s short fiction and six tales never before translated into English.', 224, 'Rowman & Littlefield'),
(135, 1, 'Les soixante-quinze feuillets', NULL, NULL, NULL, NULL),
(136, 2, 'In Search of Lost Time Volume I Swann s Way', 'http://books.google.com/books/content?id=4pi7zgEACAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api', 'In Swann’s Way, the themes of Proust’s masterpiece are introduced, and the narrator’s childhood in Paris and Combray is recalled, most memorably in the evocation of the famous maternal good-night kiss. The recollection of the narrator’s love for Swann’s daughter Gilberte leads to an account of Swann’s passion for Odette and the rise of the nouveaux riches Verdurins. For this authoritative English-language edition, D. J. Enright has revised the late Terence Kilmartin’s acclaimed reworking of C. K. Scott Moncrieff’s translation to take into account the new definitive French editions of Á la recherché du temps perdu (the final volume of these new editions was published by the Bibliothèque de la Pléiade in 1989).', 660, 'Modern Library'),
(137, 1, 'Marcel Proust : Oeuvres complètes — Les 40 titres et annexes (Nouvelle édition enrichie)', 'http://books.google.com/books/content?id=tLFaokWg8vMC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', 'L intégrale des oeuvres de Proust, soit 40 titres et annexes abondamment annotés et particulièrement destinés aux lecteurs exigeants. La mise en page et la navigation ont fait l objet d un soin particulier en intégrant les spécificités propres à votre liseuse. Les éditions Arvensa vous font bénéficier régulièrement de mises à jour gratuites et mettent à votre disposition leur service qualité. www.arvensa.com - La référence des ebooks classiques.', 8000, 'Arvensa editions'),
...
(209, 1, 'Discours et Opinions de Jules Ferry publiés avec commentaires et notes par Paul Robiquet', 'http://books.google.com/books/content?id=XPPJlPUlU8wC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', NULL, 508, NULL),
(210, 1, 'Déposition de monsieur Jules Ferry sur l insurrection du 18 mars', 'http://books.google.com/books/content?id=CdRNAQAAMAAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', NULL, 68, NULL),
(211, 1, 'Discours et Opinions de Jules Ferry publiés avec commentaires et notes par Paul Robiquet', 'http://books.google.com/books/content?id=awtZ8IzURXAC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api', NULL, 614, NULL),
...
INSERT INTO `BORROW` (`ID_USER`,`ID_BOOK`, `START_DATE`,`END_DATE`) 
 VALUES
 (1,6,'2023-03-24','2023-03-30'),
 (2,44,'2023-03-24','2023-03-30'),
 (3,8,'2023-03-24','2023-03-31'),
 (4,19,'2023-03-24','2023-04-01'),
 (5,27,'2023-03-24','2023-03-28'),
 (6,57,'2023-03-24','2023-03-26'),
 (7,18,'2023-03-24','2023-04-01'),
 (8,18,'2023-03-24','2023-03-31'),
 (9,57,'2023-03-24','2023-03-29'),
 (10,6,'2023-03-24','2023-04-03'),
 (11,36,'2023-03-24','2023-04-01'),
 (12,1,'2023-03-24','2023-03-27'),
