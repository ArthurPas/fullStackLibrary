...
--
-- Hôte : 172.16.1.2
-- Généré le : lun. 27 mars 2023 à 16:12
...
(499, '2023-03-24', '2023-04-03', 34, 499);
...
--
ALTER TABLE `test_BORROW`
  MODIFY `ID_BORROW` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=500;
...
--
ALTER TABLE `test_USER`
  MODIFY `ID_USER` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=507;
