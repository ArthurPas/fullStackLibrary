...
class User
{
    ...
    #[ORM\Column(name: "AVATAR", type: "string", length: 255, nullable: true, options: ["fixed" => true])]
    private $avatar;


     #[JoinTable(name:"follow")]
     #[JoinColumn(name:"ID_USER_FOLLOW",referencedColumnName:"ID_USER")]
     #[InverseJoinColumn(name:"ID_USER_IS_FOLLOWED",referencedColumnName:"ID_USER")]
     #[OneToMany(targetEntity:"User",inversedBy:"idUserFollow")]
