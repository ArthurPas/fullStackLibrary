...
/**
 * @component Footer - Display the footer of the website, 
 * with links to the social media of the IUT of Bordeaux
 * 
		...
		<footer>
			<div className="footer__wrapper">
				...
				<div className="footer__col">
					...
					<div className="footer__content">
						<a href="https://www.iut.u-bordeaux.fr/general/">
							IUT of Bordeaux's website
						</a>
						<a href="https://bibliotheques.u-bordeaux.fr/Les-bibliotheques/Sciences-et-Technologies/Bibliotheque-de-l-IUT-de-Bordeaux">
							Library - University of Bordeaux
						</a>
